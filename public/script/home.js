...
prev.addEventListener('click',function(){
    let arr = [];
    // console.log(parseInt(main.firstElementChild.id));
    count = parseInt(main.firstElementChild.id);
    getprod();
})
...
next.addEventListener('click', function () {
    let arr = [];
    // console.log(parseInt(main.lastElementChild.id)+1);
